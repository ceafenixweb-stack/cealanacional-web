(async () => {
  ...
  waBtn.id = "btn-whatsapp";
  waBtn.title = "Escríbenos por WhatsApp";
  waBtn.setAttribute("aria-label", "Contactar por WhatsApp");
  waBtn.target = "_blank";
  waBtn.rel = "noopener noreferrer";
  waBtn.href = `https://wa.me/${waNumber}?text=Hola%2C%20me%20interesa%20obtener%20m%C3%A1s%20informaci%C3%B3n`;
  ...
  topBtn.setAttribute("aria-label", "Volver al inicio de la página");
  topBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="18 15 12 9 6 15"/></svg>`;
  document.body.appendChild(topBtn);

  // ── Mostrar/ocultar botón arriba según scroll
